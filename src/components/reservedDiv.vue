  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const setWidth = () => {
        ...
        state.styleObject.width = width - 3 + "px";
      };
      /**
      ...
      const clickEvent = () => {
        console.log("clickEvent from reservedDiv", props.rowIndex, props.contentText);
        emit("click-event", props.rowIndex, props.keyNo, props.contentText);
      }
      /**
